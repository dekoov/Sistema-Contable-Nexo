...
public class NegocioFactura {
    ...
    /**
     * Recupera una factura por su ID inicializando los detalles en la misma
     * consulta
    ...
    /**
     * Obtiene el listado completo de facturas ordenadas de forma cronológica
     * descendente.
     */
    ...
    /**
     * Genera la sumatoria del valor total facturado agrupado por cada ciudad
     * registrada.
     */
    ...
    /**
     * Resuelve el valor entero consecutivo para la clave primaria de la tabla
     * cabecera.
     */
    ...
    /**
     * Resuelve el valor entero consecutivo para la clave primaria de la tabla de
     * detalles.
     */
     ...
     * 
     * @param idArticulo         Identificador en formato BigDecimal requerido por
     *                           inventarios.
