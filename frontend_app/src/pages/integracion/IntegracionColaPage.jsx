            ...
            <div className="page-heading">
                <div>
                    ...
                    <p>
                        ...
                        importación hacia Inventario y Cuentas por Cobrar.
                    </p>
                </div>
                                        ...
                                        >
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2 justify-content-between">
                                                    <span>
                                                        {registro.comprobanteGenerado
                                                            ?.numeroComprobante ??
                                                            "Sin comprobante"}
                                                    </span>
                                                    {registro.estado === "PROCESADO" && registro.payload?.idFactura && (
                                                        <button
                                                            type="button"
                                                            ...
                                                            onClick={() => {
                                                                navigate("/cxc/pagos", {
                                                                    state: {
                                                                        idFacturaPreseleccionada: registro.payload.idFactura,
                                                                    },
                                                                });
                                                            }}
                                                        >
